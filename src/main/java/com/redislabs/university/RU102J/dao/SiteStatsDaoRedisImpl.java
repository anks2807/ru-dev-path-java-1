...
public class SiteStatsDaoRedisImpl implements SiteStatsDao {
    ...
    private void updateOptimized(Jedis jedis, String key, MeterReading reading) {
        ...
        try (Transaction t = jedis.multi()) {
            ...
            compareAndUpdateScript.updateIfGreater(t, key, SiteStats.maxWhField,
                    reading.getWhGenerated());

            compareAndUpdateScript.updateIfLess(t, key, SiteStats.minWhField,
                    reading.getWhGenerated());

            compareAndUpdateScript.updateIfGreater(t, key, SiteStats.maxCapacityField,
